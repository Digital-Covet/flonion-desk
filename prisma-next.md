...
Your data contract is the heart of your application. It lives at [`app/prisma/contract.prisma`](app/prisma/contract.prisma) and describes your models:
...
| File | Purpose |
|---|---|
| [`app/prisma/contract.prisma`](app/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`app/prisma/db.ts`](app/prisma/db.ts) | Database client — `import { db } from './app/prisma/db'` |
| `app/prisma/contract.json` | Compiled contract (generated) |
| `app/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`app/prisma/contract.prisma`](app/prisma/contract.prisma) to add or change models.
